  ...
  return (
    <div className="px-5 pt-14">
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="border border-gray-200 dark:border-gray-700 rounded-full px-4 py-1.5 text-sm font-medium flex items-center gap-1 dark:text-white">
          + Add
        </button>
      </div>
      ...
      <section className="mb-6">
        ...
        <div className="border border-gray-100 dark:border-gray-700 rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-sm dark:text-white">Bounce Pay</p>
        ...
        <div className="space-y-2">
          <div className="border border-gray-100 dark:border-gray-700 rounded-xl p-4 flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-semibold text-sm dark:text-white">RBC Royal Bank</p>
